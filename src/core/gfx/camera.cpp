...
namespace sfg_trajectory_planner::core::gfx
{
    ...
    void Camera::pan(const glm::vec2 &position)
    {
        ...
        auto distance = core::gfx::utils::intersect_ray_plane(ray, m_focus_point, glm::inverse(m_view_matrix) * core::gfx::utils::s_forward);
    ...
    void Camera::update()
    {
        ...
        glm::mat4 rotation = glm::rotate(glm::mat4(1.0f), m_orientation.z, core::gfx::utils::s_up.xyz()) * glm::rotate(glm::mat4(1.0f), m_orientation.y, core::gfx::utils::s_right.xyz());
        ...
        glm::mat4 center_offset = glm::translate(glm::mat4(1.0f), glm::vec3(0, 0, m_projection == core::gfx::Camera::Projection::Perspective ? m_zoom_level : core::gfx::Camera::s_far_plane / 2.0f));
