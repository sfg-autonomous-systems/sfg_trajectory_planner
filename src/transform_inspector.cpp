...
namespace sfg_trajectory_planner
{
    ...
    glm::mat4 TransformInspector::get_transform_matrix() const
    {
        ...
        rotation_matrix = glm::rotate(rotation_matrix, glm::radians(m_rotation.y), gfx_utils::s_up.xyz());
        rotation_matrix = glm::rotate(rotation_matrix, glm::radians(m_rotation.x), gfx_utils::s_right.xyz());
        rotation_matrix = glm::rotate(rotation_matrix, glm::radians(m_rotation.z), gfx_utils::s_forward.xyz());
